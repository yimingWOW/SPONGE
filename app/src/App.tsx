  ...
  return (
    <div className="app-container">
      <nav className="app-nav">
        <div className="brand">
          <img src={logo} alt="SPONGE Logo" className="app-logo" />
          <h1 className="cash-title">SPONGE</h1>
        </div>
        ...
        {!connected ? (
          <div className="connect-wallet">
            <div className="wrapper">
              <img src={logo} alt="SPONGE Logo" className="connect-logo" />
              <h2 className="section-title">Welcome to SPONGE</h2>
      ...
      <div className="social-links-corner">
        <a 
          href="https://github.com/yimingWOW/cash" 
          target="_blank" 
